...
\node[block,right=70mm of S_sub] (M_sub) {M};
...
\draw[line] (M_sub) to[bend right=37.5] node[e,pos=0.5] {AAA1\textrightarrow{}A} (S_sub);
...
%%% Indel FST
\node[right=10cm of titlea] (titleb) {\textbf{a) Insertion-Deletion}};
