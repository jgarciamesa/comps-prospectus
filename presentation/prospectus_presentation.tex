...
% \titlegraphic[\includegraphics[width=0.3\linewidth]{x.pdf}
...
\column{0.4\textwidth}	
\includegraphics[width=\textwidth]{images/iupac.png}
\end{columns}
...
\hspace{0.7cm}\centering{\input{../resources/figures/table-comp.tex}}
}
