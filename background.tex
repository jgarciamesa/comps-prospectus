...
Despite the existence of models for codon evolution, a common strategy is to
base the alignment of coding sequences on amino acid translations \red{citation}.
